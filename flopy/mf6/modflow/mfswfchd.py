...
class ModflowSwfchd(mfpackage.MFPackage):
    """
    ModflowSwfchd defines a chd package within a swf6 model.
    ...
    """
    auxiliary = ListTemplateGenerator(('swf6', 'chd', 'options',
                                       'auxiliary'))
    ts_filerecord = ListTemplateGenerator(('swf6', 'chd', 'options',
                                           'ts_filerecord'))
    obs_filerecord = ListTemplateGenerator(('swf6', 'chd', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('swf6', 'chd', 'period',
                                                'stress_period_data'))
    package_abbr = "swfchd"
    _package_type = "chd"
    dfn_file_name = "swf-chd.dfn"
