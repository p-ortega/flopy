...
class ModflowUtlspt(mfpackage.MFPackage):
    ...
    """
    ts_filerecord = ListTemplateGenerator(('spt', 'options',
                                           'ts_filerecord'))
    ...
    dfn = [
           ...
           ["block period", "name perioddata",
            "type recarray bndno sptsetting", "shape", "reader urword"],
           ["block period", "name bndno", "type integer", "shape",
            "tagged false", "in_record true", "reader urword",
            "numeric_index true"],
           ["block period", "name sptsetting", "type keystring temperature",
    ...
    def __init__(self, model, loading_package=False, print_input=None,
        ...
        super().__init__(model, "spt", filename, pname,
