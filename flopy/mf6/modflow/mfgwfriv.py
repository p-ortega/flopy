...
class ModflowGwfriv(mfpackage.MFPackage):
    ...
    auxmultname : string
        * auxmultname (string) name of auxiliary variable to be used as
          multiplier of riverbed conductance.
    boundnames : boolean
    ...
    mover : boolean
        * mover (boolean) keyword to indicate that this instance of the River
    ...
    stress_period_data : [cellid, stage, cond, rbot, aux, boundname]
        ...
        * stage (double) is the head in the river. If the Options block
        ...
        * cond (double) is the riverbed hydraulic conductance. If the Options
          block includes a TIMESERIESFILE entry (see the "Time-Variable Input"
          section), values can be obtained from a time series by entering the
          time-series name in place of a numeric value.
        * rbot (double) is the elevation of the bottom of the riverbed. If the
        ...
        * aux (double) represents the values of the auxiliary variables for
          each river. The values of auxiliary variables must be present for
          each river. The values must be specified in the order of the
