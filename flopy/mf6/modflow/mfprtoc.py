...
class ModflowPrtoc(mfpackage.MFPackage):
    ...
    trackcsv_filerecord = ListTemplateGenerator(('prt6', 'oc', 'options',
                                                 'trackcsv_filerecord'))
    track_timesrecord = ListTemplateGenerator(('prt6', 'oc', 'options',
                                               'track_timesrecord'))
    track_timesfilerecord = ListTemplateGenerator(('prt6', 'oc',
                                                   'options',
    ...
    dfn = [
           ...
           ["block options", "name track_usertime", "type keyword",
            "reader urword", "optional true"],
           ["block options", "name track_timesrecord",
            "type record track_times times", "shape", "reader urword",
            "tagged true", "optional true"],
           ["block options", "name track_times", "type keyword",
           ...
           ["block options", "name track_timesfilerecord",
            "type record track_timesfile timesfile", "shape", "reader urword",
            "tagged true", "optional true"],
           ["block options", "name track_timesfile", "type keyword",
            "reader urword", "in_record true", "tagged true", "shape"],
    ...
    def __init__(self, model, loading_package=False, budget_filerecord=None,
                 ...
                 track_weaksink=None, track_usertime=None,
                 track_timesrecord=None, track_timesfilerecord=None,
        ...
        self.track_usertime = self.build_mfdata("track_usertime",
                                                track_usertime)
        self.track_timesrecord = self.build_mfdata("track_timesrecord",
                                                   track_timesrecord)
        self.track_timesfilerecord = self.build_mfdata("track_timesfilerecord",
                                                       track_timesfilerecord)
