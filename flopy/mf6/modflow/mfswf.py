...
class ModflowSwf(mfmodel.MFModel):
    """
    Modflowswf defines a swf model
    ...
    def __init__(self, simulation, modelname='model', model_nam_file=None,
                 ...
                 newtonoptions=None, **kwargs,):
        super().__init__(simulation, model_type='swf6',
                         modelname=modelname,
