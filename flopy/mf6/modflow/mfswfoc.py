...
class ModflowSwfoc(mfpackage.MFPackage):
    """
    ModflowSwfoc defines a oc package within a swf6 model.
    ...
    """
    budget_filerecord = ListTemplateGenerator(('swf6', 'oc', 'options',
                                               'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('swf6', 'oc',
                                                  'options',
                                                  'budgetcsv_filerecord'))
    qoutflow_filerecord = ListTemplateGenerator(('swf6', 'oc', 'options',
                                                 'qoutflow_filerecord'))
    stage_filerecord = ListTemplateGenerator(('swf6', 'oc', 'options',
                                              'stage_filerecord'))
    qoutflowprintrecord = ListTemplateGenerator(('swf6', 'oc', 'options',
                                                 'qoutflowprintrecord'))
    saverecord = ListTemplateGenerator(('swf6', 'oc', 'period',
                                        'saverecord'))
    printrecord = ListTemplateGenerator(('swf6', 'oc', 'period',
                                         'printrecord'))
    package_abbr = "swfoc"
    _package_type = "oc"
    dfn_file_name = "swf-oc.dfn"
