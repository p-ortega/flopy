...
class ModflowSwfcdb(mfpackage.MFPackage):
    """
    ModflowSwfcdb defines a cdb package within a swf6 model.
    ...
    boundnames : boolean
        * boundnames (boolean) keyword to indicate that boundary names may be
          provided with the list of critical depth boundary cells.
    print_input : boolean
        * print_input (boolean) keyword to indicate that the list of critical
          depth boundary information will be written to the listing file
          immediately after it is read.
    print_flows : boolean
        * print_flows (boolean) keyword to indicate that the list of critical
          depth boundary flow rates will be printed to the listing file for
    ...
    save_flows : boolean
        * save_flows (boolean) keyword to indicate that critical depth boundary
    ...
    maxbound : integer
        * maxbound (integer) integer value specifying the maximum number of
          critical depth boundary cells that will be specified for use during
          any stress period.
    ...
    """
    auxiliary = ListTemplateGenerator(('swf6', 'cdb', 'options',
                                       'auxiliary'))
    obs_filerecord = ListTemplateGenerator(('swf6', 'cdb', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('swf6', 'cdb', 'period',
                                                'stress_period_data'))
    package_abbr = "swfcdb"
    _package_type = "cdb"
    dfn_file_name = "swf-cdb.dfn"
    ...
    def __init__(self, model, loading_package=False, auxiliary=None,
                 ...
                 save_flows=None, filein=None, observations=None,
                 maxbound=None, stress_period_data=None, filename=None,
                 pname=None, **kwargs):
        super().__init__(model, "cdb", filename, pname,
