...
# FILE created on August 15, 2024 06:58:14 UTC
from .. import mfpackage
from ..data.mfdatautil import ListTemplateGenerator


class ModflowSwfzdg(mfpackage.MFPackage):
    """
    ModflowSwfzdg defines a zdg package within a swf6 model.
    ...
    boundnames : boolean
        * boundnames (boolean) keyword to indicate that boundary names may be
          provided with the list of zero-depth-gradient boundary cells.
    print_input : boolean
        * print_input (boolean) keyword to indicate that the list of zero-
          depth-gradient boundary information will be written to the listing
          file immediately after it is read.
    print_flows : boolean
        * print_flows (boolean) keyword to indicate that the list of zero-
          depth-gradient boundary flow rates will be printed to the listing
          file for every stress period time step in which "BUDGET PRINT" is
    ...
    save_flows : boolean
        * save_flows (boolean) keyword to indicate that zero-depth-gradient
          boundary flow terms will be written to the file specified with
    ...
    maxbound : integer
        * maxbound (integer) integer value specifying the maximum number of
          zero-depth-gradient boundary cells that will be specified for use
          during any stress period.
    stress_period_data : [cellid, idcxs, width, slope, rough, aux, boundname]
        ...
        * idcxs (integer) is the identifier for the cross section specified in
          the CXS Package. A value of zero indicates the zero-depth-gradient
          calculation will use parameters for a hydraulically wide channel.
          ...
          automatically subtract one when loading index variables and add one
          when writing index variables.
        * width (double) is the channel width of the zero-depth gradient
          boundary. If a cross section is associated with this boundary, the
          width will be scaled by the cross section information. If the Options
        ...
        * slope (double) is the channel slope used to calculate flow to the
          zero-depth-gradient boundary. If the Options block includes a
        ...
        * rough (double) is the Manning channel roughness value used to
          calculate flow to the zero-depth-gradient boundary. If a cross
          section is associated with this boundary, the roughness value will be
          multiplied by the roughness fraction for each part of the cross
          section. If the Options block includes a TIMESERIESFILE entry (see
        ...
        * aux (double) represents the values of the auxiliary variables for
          each zero-depth-gradient boundary. The values of auxiliary variables
          must be present for each zero-depth-gradient boundary. The values
          must be specified in the order of the auxiliary variables specified
          in the OPTIONS block. If the package supports time series and the
        ...
        * boundname (string) name of the zero-depth-gradient boundary cell.
          BOUNDNAME is an ASCII character variable that can contain as many as
          40 characters. If BOUNDNAME contains spaces in it, then the entire
    ...
    """
    auxiliary = ListTemplateGenerator(('swf6', 'zdg', 'options',
                                       'auxiliary'))
    ts_filerecord = ListTemplateGenerator(('swf6', 'zdg', 'options',
                                           'ts_filerecord'))
    obs_filerecord = ListTemplateGenerator(('swf6', 'zdg', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('swf6', 'zdg', 'period',
                                                'stress_period_data'))
    package_abbr = "swfzdg"
    _package_type = "zdg"
    dfn_file_name = "swf-zdg.dfn"
    ...
    dfn = [
           ...
           ["block period", "name cellid", "type integer",
            ...
            "reader urword"],
           ["block period", "name idcxs", "type integer", "shape",
            "tagged false", "in_record true", "reader urword",
            "time_series false", "numeric_index true"],
           ["block period", "name width", "type double precision", "shape",
            "tagged false", "in_record true", "reader urword",
            "time_series true"],
           ["block period", "name slope", "type double precision", "shape",
            "tagged false", "in_record true", "reader urword",
            "time_series true"],
           ["block period", "name rough", "type double precision", "shape",
            "tagged false", "in_record true", "reader urword",
            "time_series true"],
    ...
    def __init__(self, model, loading_package=False, auxiliary=None,
                 ...
                 save_flows=None, timeseries=None, observations=None,
                 maxbound=None, stress_period_data=None, filename=None,
                 pname=None, **kwargs):
        super().__init__(model, "zdg", filename, pname,
