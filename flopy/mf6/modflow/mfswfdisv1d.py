...
class ModflowSwfdisv1D(mfpackage.MFPackage):
    """
    ModflowSwfdisv1D defines a disv1d package within a swf6 model.
    ...
    """
    length = ArrayTemplateGenerator(('swf6', 'disv1d', 'griddata',
                                     'length'))
    width = ArrayTemplateGenerator(('swf6', 'disv1d', 'griddata',
                                    'width'))
    bottom = ArrayTemplateGenerator(('swf6', 'disv1d', 'griddata',
                                     'bottom'))
    idomain = ArrayTemplateGenerator(('swf6', 'disv1d', 'griddata',
                                      'idomain'))
    vertices = ListTemplateGenerator(('swf6', 'disv1d', 'vertices',
                                      'vertices'))
    cell2d = ListTemplateGenerator(('swf6', 'disv1d', 'cell2d',
                                    'cell2d'))
    package_abbr = "swfdisv1d"
    _package_type = "disv1d"
    dfn_file_name = "swf-disv1d.dfn"
    ...
    dfn = [
           ...
           ["block dimensions", "name nvert", "type integer",
            "reader urword", "optional true"],
           ["block griddata", "name length", "type double precision",
            "shape (nodes)", "valid", "reader readarray", "layered false",
            "optional"],
           ["block griddata", "name width", "type double precision",
            "shape (nodes)", "valid", "reader readarray", "layered false",
            "optional"],
           ...
           ["block cell2d", "name cell2d",
            "type recarray icell2d fdc ncvert icvert", "shape (nodes)",
            "reader urword", "optional false"],
           ["block cell2d", "name icell2d", "type integer",
            "in_record true", "tagged false", "reader urword",
            "optional false", "numeric_index true"],
           ["block cell2d", "name fdc", "type double precision",
            "in_record true", "tagged false", "reader urword",
            "optional false"],
    ...
    def __init__(self, model, loading_package=False, length_units=None,
                 ...
                 export_array_ascii=None, nodes=None, nvert=None, length=None,
                 width=None, bottom=None, idomain=None, vertices=None,
                 cell2d=None, filename=None, pname=None, **kwargs):
        super().__init__(model, "disv1d", filename, pname,
