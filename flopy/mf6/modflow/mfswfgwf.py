...
class ModflowSwfgwf(mfpackage.MFPackage):
    ...
    """
    obs_filerecord = ListTemplateGenerator(('swfgwf', 'options',
                                            'obs_filerecord'))
    exchangedata = ListTemplateGenerator(('swfgwf', 'exchangedata',
                                          'exchangedata'))
    package_abbr = "swfgwf"
    ...
    dfn = [
           ...
           ["block exchangedata", "name exchangedata",
            "type recarray cellidm1 cellidm2 cond", "shape (nexg)",
            "reader urword", "optional false"],
           ...
           ["block exchangedata", "name cellidm2", "type integer",
            "in_record true", "tagged false", "reader urword",
            "optional false", "numeric_index true"],
           ["block exchangedata", "name cond", "type double precision",
            "in_record true", "tagged false", "reader urword",
            "optional false"]]

    def __init__(self, simulation, loading_package=False, exgtype="SWF6-GWF6",
                 exgmnamea=None, exgmnameb=None, print_input=None,
                 print_flows=None, observations=None, nexg=None,
                 exchangedata=None, filename=None, pname=None, **kwargs):
        super().__init__(simulation, "swfgwf", filename, pname,
