...
class ModflowSwfcxs(mfpackage.MFPackage):
    """
    ModflowSwfcxs defines a cxs package within a swf6 model.
    ...
    """
    packagedata = ListTemplateGenerator(('swf6', 'cxs', 'packagedata',
                                         'packagedata'))
    crosssectiondata = ListTemplateGenerator(('swf6', 'cxs',
                                              'crosssectiondata',
                                              'crosssectiondata'))
    package_abbr = "swfcxs"
    _package_type = "cxs"
    dfn_file_name = "swf-cxs.dfn"

    dfn = [
           ["header", ],
           ["block options", "name print_input", "type keyword",
            "reader urword", "optional true", "mf6internal iprpak"],
           ["block dimensions", "name nsections", "type integer",
            "reader urword", "optional false"],
           ["block dimensions", "name npoints", "type integer",
            "reader urword", "optional false"],
           ["block packagedata", "name packagedata",
            "type recarray idcxs nxspoints", "shape (nsections)",
            "reader urword"],
           ["block packagedata", "name idcxs", "type integer", "shape",
            "tagged false", "in_record true", "reader urword",
            "numeric_index true"],
           ["block packagedata", "name nxspoints", "type integer", "shape",
            "tagged false", "in_record true", "reader urword"],
           ["block crosssectiondata", "name crosssectiondata",
            "type recarray xfraction height manfraction", "shape (npoints)",
            "reader urword"],
           ["block crosssectiondata", "name xfraction",
            "type double precision", "shape", "tagged false",
            "in_record true", "reader urword"],
           ["block crosssectiondata", "name height",
            "type double precision", "shape", "tagged false",
            "in_record true", "reader urword"],
           ["block crosssectiondata", "name manfraction",
            "type double precision", "shape", "tagged false",
            "in_record true", "reader urword", "optional false"]]

    def __init__(self, model, loading_package=False, print_input=None,
                 nsections=None, npoints=None, packagedata=None,
                 crosssectiondata=None, filename=None, pname=None, **kwargs):
        super().__init__(model, "cxs", filename, pname,
        ...
        self.crosssectiondata = self.build_mfdata("crosssectiondata",
                                                  crosssectiondata)
