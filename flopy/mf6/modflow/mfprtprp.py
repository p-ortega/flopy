...
class ModflowPrtprp(mfpackage.MFPackage):
    ...
    trackcsv_filerecord = ListTemplateGenerator(('prt6', 'prp',
                                                 'options',
                                                 'trackcsv_filerecord'))
    release_timesrecord = ListTemplateGenerator(('prt6', 'prp',
                                                 'options',
                                                 'release_timesrecord'))
    release_timesfilerecord = ListTemplateGenerator(('prt6', 'prp',
                                                     'options',
    ...
    dfn = [
           ...
           ["block options", "name drape", "type keyword", "reader urword",
            "optional true"],
           ["block options", "name release_timesrecord",
            "type record release_times times", "shape", "reader urword",
            "tagged true", "optional true"],
           ["block options", "name release_times", "type keyword",
            "reader urword", "in_record true", "tagged true", "shape"],
           ["block options", "name times", "type double precision",
            "shape (unknown)", "reader urword", "in_record true",
            "tagged false", "repeating true"],
           ["block options", "name release_timesfilerecord",
            "type record release_timesfile timesfile", "shape",
            "reader urword", "tagged true", "optional true"],
           ["block options", "name release_timesfile", "type keyword",
            "reader urword", "in_record true", "tagged true", "shape"],
           ["block options", "name timesfile", "type string",
            "preserve_case true", "shape", "in_record true", "reader urword",
            "tagged false", "optional false"],
    ...
    def __init__(self, model, loading_package=False, boundnames=None,
                 ...
                 exit_solve_tolerance=None, local_z=None,
                 track_filerecord=None, trackcsv_filerecord=None,
                 stoptime=None, stoptraveltime=None, stop_at_weak_sink=None,
                 istopzone=None, drape=None, release_timesrecord=None,
                 release_timesfilerecord=None, dev_forceternary=None,
                 nreleasepts=None, packagedata=None, perioddata=None,
        ...
        self.release_timesrecord = self.build_mfdata("release_timesrecord",
                                                     release_timesrecord)
